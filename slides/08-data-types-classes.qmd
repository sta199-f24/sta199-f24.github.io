...
webr:
  packages:
    - tidyverse
  resources:
    - "https://raw.githubusercontent.com/sta199-f24/sta199-f24.github.io/refs/heads/main/slides/data/STA%20199%20-%20Data%20collection%202024-09-24%20(Responses)%20-%20Form%20Responses%201.csv"
editor_options: 
...
#| output: false
options(width = 60)
students <- read_csv("https://raw.githubusercontent.com/sta199-f24/sta199-f24.github.io/refs/heads/main/slides/data/STA%20199%20-%20Data%20collection%202024-09-24%20(Responses)%20-%20Form%20Responses%201.csv")
```
...
#| include: false
library(tidyverse)
students <- read_csv("data/STA 199 - Data collection 2024-09-24 (Responses) - Form Responses 1.csv")
```
...
#| fig-width: 7
#| fig-asp: 0.5
ggplot(students, mapping = aes(x = year)) +
  geom_bar()
```

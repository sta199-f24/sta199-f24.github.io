...
#| fig-width: 9
#| fig-height: 3
ggplot(us_uk_tr_votes, mapping = aes(x = year))
```
...
::: callout-note
We dropped the name of the mapping argument from the function call to save some space, as is commonly done.
:::
...
- It tells us the type of smoothing ggplot2 does under the hood when drawing the smooth curves representing trends for each country.

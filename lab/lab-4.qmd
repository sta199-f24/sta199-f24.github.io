...
![The \`datasaurus_dozen\` data frame stacks 13 datasets on top of each other. This figure shows the first three datasets.](images/lab-4/datasaurus-dozen.png){fig-align="center" width="432"}
...
## Part 4 - Medical marijuana in NC
...
## Part 2 - Team USA at the Olympics

### Question 9

2020 vs. 2024 Team USA roster

a. read from excel file with skip
...
Turns out spelling differences for someone obvious to most...

fix

and then do parts a and b again.

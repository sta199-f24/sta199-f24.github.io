...
a\.
In a single pipeline, calculate the total population for each state and save the resulting data frame as `state_population`. Then, display the data frame, `state_population`, in descending order of total population.

b\.
Then, in a separate pipeline, calculate the proportion of the total population in each state. Once again, display the results in descending order of proportion of population.

...
You should commit states that are *meaningful to you* for inspection, comparison, or restoration (going back and restoring a previous version of your document).
...
Remember that in order to push your changes to GitHub, you must have **staged** (checkec boxes) your **commit** (with a commit message) to be pushed and then clicked on **Push**.
:::
...
The lab is graded out of a total of \_\_\_ points.

::: callout-important
TO DO: Add grading scheme.
:::

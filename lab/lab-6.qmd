...
a. ** Data Prep **  What happens when you take the natural log of 0? Remove rows of your data set where life_expectancy = 0, justifing        why this is helpful.
...
c.  **Prediction:** Predict the life expectacy of a country in Asia where the average GDP per capita is $70,000. Do this using R functions, not by manually plugging in numbers.
